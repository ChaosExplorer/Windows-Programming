...
{
	fprintf(stderr, "\n");
	fprintf(stderr, "Program: vans_pmseq (alignment via Burrows-Wheeler transformation)\n");
	fprintf(stderr, "Version: %s\n", PACKAGE_VERSION);
	fprintf(stderr, "Contact: bgi_chaos \n\n");
...
int main(int argc, char *argv[])
{
	...
	if (strcmp(argv[1], "mem") == 0) ret = main_mem(argc-1, argv+1);
